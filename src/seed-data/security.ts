...
export const exchanges: ExchangeConnection[] = [
  ...
  },
  {
    ...
    permissions: [],
    routingNote: 'Wallet route planned. Live execution stays locked until a signed dYdX adapter is configured.',
    status: 'available',
    venueType: 'dex',
    walletRequired: true,
    withdrawalsEnabled: false,
  },
  {
    ...
    permissions: [],
    routingNote: 'Wallet route planned. Live execution stays locked until a signed Hyperliquid adapter is configured.',
    status: 'available',
    venueType: 'dex',
    walletRequired: true,
    withdrawalsEnabled: false,
