...
Le frontend de Thoon utilise **Next.js App Router** avec React et TypeScript.

Règle pour tous les prochains goals :

- Toujours partir de Next.js.
- Ne pas revenir à Vite ou React Router sauf demande explicite.
- Garder les composants interactifs en client components uniquement quand nécessaire.
